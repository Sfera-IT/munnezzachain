...
export function privacyView() {
  ...
  return h(
    ...
    h(
      ...
      h("li", null, "Informazioni tecniche sulla connessione: paese di provenienza e tipo di browser. L'indirizzo IP non viene conservato."),
    ),
    ...
    h("h2", null, "Dove"),
    h("p", null, "I dati sono conservati su infrastruttura Cloudflare con localizzazione nell'Unione Europea."),
